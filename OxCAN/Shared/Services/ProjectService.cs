...
public class ProjectService : IProjectService
{
    private readonly List<Project> allProjects = new List<Project>()
    {
        ...
        new Project{ Name = "Green Acres Roundabout Park", Description= "Located at the corner of Tranquil Drive and Hillcrest, residents have expressed an interest in turning this City-owned and maintained island into a pocket park, and rallying residents to help beautify this space, and turning it into an attractive destination.r", ImageLink="images/green-acres-roundabout.png", ProjectStatus=Project.Status.Future},
        ...
        new Project{ Name = "Lake Devin Trail Network/Red Barn Upkeep", Description= "The City Parks facilities at Lake Devin are a part of Oxford’s culture, and holds lots of memories for long-term Oxford residents. This effort is two-fold: we want to offer support to:\n1. The Lake Devin trail network, a shovel-ready project that has been proposed to the City by several private citizens.\n2. Helping to save the Red Barn, which has fallen into disrepair.", ImageLink="images/lake-devin-trail.png", ProjectStatus=Project.Status.Future},
    };
